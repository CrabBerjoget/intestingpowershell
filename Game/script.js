	...
	1: [function (require, module, exports) {
		...
		function e() {
			...
			Il2Cpp.perform((() => {
				...
				e.class("GameManager").method("Quit").implementation = function(a){
					if(a != 22 && a != 18){
						this.method("Quit").invoke(a);
					}
				}
				e.class("LauncherSDKCtr").method("Init").implementation = function(a,b){
					// this.field("debugEnable").value = true;
					a.method("Invoke").invoke()
					// this.method("Init").invoke(a,b);
				}
				// e.class("WMPCLauncherPlugin.WMPCLauncherWindowsCore").method("Init").implementation = function(a,b,c,d){
				// 	this.field("debugEnable").value = true;
				// 	this.method("EnableDebugMode").invoke(true)
				// 	this.method("Init").invoke(a,b,c,d);
				// }
			}));
		}
