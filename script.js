	...
	1: [function (require, module, exports) {
		...
		function e() {
			...
			Il2Cpp.perform((() => {
				...
				e.class("Script.View.Managers.SDKManager").method("CreateSdkAgent").implementation = function(type){
					// showMessageBoxA(JSON.stringify(type));
					type = e.class("Script.View.Managers.SdkAgent.PackChannel").field("NoSdk").value;
					return this.method('CreateSdkAgent').invoke(type);
				}
				showMessageBoxA("by FlxSNX");
			}));
		}
