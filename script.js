(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
	1: [function (require, module, exports) {
		...
		function e() {
            ...
            // 弹出一个 ANSI 提示框
            function showMessageBoxA(message,title="Info") {
                const pTitle = Memory.allocUtf8String(title);
                const pMessage = Memory.allocUtf8String(message);
                MessageBoxA(0, pMessage, pTitle, 0);
            }

            // // 弹出一个 Unicode 提示框
            function showMessageBoxW(title, message) {
                const pTitle = Memory.allocUtf16String(title);
                const pMessage = Memory.allocUtf16String(message);
                MessageBoxW(0, pMessage, pTitle, 0);
            }

			const MessageBoxTimeout = new NativeFunction(
				Module.findExportByName('user32.dll', 'MessageBoxTimeoutA'),
				'int', ['int', 'pointer', 'pointer', 'int', 'int', 'int']
			);

			function showMessageBoxAc(message, title = "Info", timeout = 100) {
				const pTitle = Memory.allocUtf8String(title);
				const pMessage = Memory.allocUtf8String(message);
			...
			try {
				showMessageBoxAc("by FlxSNX");
			} catch (error) {
				showMessageBoxA(error.toString())
			}

			Il2Cpp.perform((() => {
				var e = Il2Cpp.Domain.assembly("Assembly-CSharp").image;
				var e2 = Il2Cpp.Domain.assembly("Assembly-CSharp-firstpass").image;
				var s = Il2Cpp.Domain.assembly("com.rlabrecque.steamworks.net").image;
				
				e2.class("YCore.Global").method("GetValue").implementation = function(a){
					let ret = this.method("GetValue").invoke(a);
					if(a.toString() == '"GAME_SDK"'){
						return Il2Cpp.String.from("Dev");
					}
					if(a.toString() == '"IS_DEBUG"'){
						return Il2Cpp.String.from("1");
					}
					return ret;
				}

				e2.class("Youda.HttpClientMgr").method("Post").implementation = function(a,b,c,d,e,f){
					return this.method("Post").invoke(a,b,c,d,e,f);
				}


				try {
					function parseReq(data){
						let d = data.toString().slice(1, -1);
						return JSON.parse(d);
					}
					
					e2.class("Youda.HttpClientMgr").method("PostRequest").implementation = function(a,b,c,d,e,f){
						if (a.toString().indexOf("dlc1/user/login") > -1){
							c.method("Invoke").invoke(Il2Cpp.String.from(JSON.stringify({"code":0,"have":true})));
						}else if(a.toString().indexOf("user/login") > -1){
							c.method("Invoke").invoke(Il2Cpp.String.from(JSON.stringify({"expiretime":1743544655,"signkey":"gd0630344f107279e27ae492f7a350c1a","token":"gd0630344f107279e27ae492f7a350c1a","servertime":1742939855,"uid":2786537,"code":0})));
						}else if(a.toString().indexOf("user/getdata") > -1){
							c.method("Invoke").invoke(Il2Cpp.String.from(JSON.stringify({"character":[{"id":1024,"favor":0},{"id":1025,"favor":0},{"id":1026,"favor":0},{"id":1027,"favor":0},{"id":1028,"favor":0},{"id":1029,"favor":0},{"id":1030,"favor":0},{"id":1031,"favor":0},{"id":1032,"favor":0},{"id":1033,"favor":0},{"id":1034,"favor":0},{"id":1035,"favor":0},{"id":1036,"favor":0},{"id":1037,"favor":0},{"id":1038,"favor":0},{"id":1039,"favor":0},{"id":1040,"favor":0},{"id":1041,"favor":0},{"id":1042,"favor":0},{"id":1043,"favor":0},{"id":1044,"favor":0},{"id":1001,"favor":7},{"id":1002,"favor":-4},{"id":1006,"favor":11},{"id":1007,"favor":0},{"id":1008,"favor":0},{"id":1009,"favor":0},{"id":1010,"favor":0},{"id":1011,"favor":0},{"id":1012,"favor":0},{"id":1013,"favor":0},{"id":1014,"favor":0},{"id":1015,"favor":0},{"id":1021,"favor":0},{"id":1022,"favor":0},{"id":1023,"favor":0}],"line":[{"front":10010014,"id":10010016},{"front":10010016,"id":10010018},{"front":10010018,"id":10010021},{"front":10010021,"id":10010023},{"front":10010023,"id":10010024},{"front":10010024,"id":10010026},{"front":10010026,
{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060005},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060006},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060007},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060008},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060009},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060010},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060011},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060012},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060013},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060014},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060015},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060016},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060017},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060018},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060019},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060020},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060021},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060022},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060023},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060024},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060025},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060026},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060027},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060028},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060029},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060030},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060031},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060032},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060033},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060034},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060035},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060036},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060037},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060038},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060039},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060040},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060041},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060042},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060043},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060044},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060045},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060046},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060047},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060048},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060049},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060050},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060051},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060052},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060053},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060054},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060055},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060056},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060057},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060058},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060059},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060060},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060061},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060062},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060064},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060065},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060066},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060067},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060068},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060069},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060070},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060071},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060072},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060073},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060074},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060075},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060076},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060077},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060078},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060079},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060080},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060081},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060082},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060083},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060084},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060085},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060086},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060087},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060088},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060089},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060090},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060091},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060092},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060093},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060094},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060095},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060096},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060097},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060098},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060099},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060100},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060101},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060102},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060103},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060104},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060105},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060106},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060107},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060108},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060109},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060110},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060112},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060113},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060114},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060115},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060116},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060117},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060118},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060119},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060120},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060121},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060122},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060123},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060124},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060125},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060126},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060127},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060129},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060130},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060131},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060132},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060133},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060134},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060135},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060136},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060137},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060138},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060139},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060140},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060142},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060143},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060144},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060145},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060146},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060147},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060148},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060149},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060150},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060151},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060152},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060153},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060154},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060155},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060156},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060157},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060158},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060159},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060160},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060161},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060162},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060163},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060164},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060165},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060166},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060167},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060168},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060169},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060170},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060171},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060172},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060173},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060174},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060175},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060176},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060177},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060178},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060179},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060180},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060181},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060182},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060183},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060184},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060185},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060186},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060187},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060188},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060189},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060190},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060191},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060192},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060193},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060194},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060195},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060196},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060197},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060198},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060202},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060203},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060204},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060205},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060206},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060207},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060208},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060209},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060210},{"passtime":1743053081,"unlocktime":1743053079,"status":1,"id":10060211}],"uid":2786537,"last_play_level":10010042})));
						}else if(a.toString().indexOf("user/getunlockchapter") > -1){
							c.method("Invoke").invoke(Il2Cpp.String.from(JSON.stringify({"chapters":[{"time":1742939863,"id":1001},{"time":1742939863,"id":1002},{"time":1742939863,"id":1003},{"time":1742939863,"id":1004},{"time":1742939863,"id":1005},{"time":1742939863,"id":1006},{"time":1742939863,"id":1007},{"time":1742939863,"id":1008},{"time":1742939863,"id":1009},{"time":1742939863,"id":1010},{"time":1742939863,"id":1011}],"code":0,"drewlist":{}})));
						}else if(a.toString().indexOf("user/getcurrencydata") > -1){
							c.method("Invoke").invoke(Il2Cpp.String.from(JSON.stringify({"list":[{"num":15,"id":1}],"code":0})));
						}else if(a.toString().indexOf("user/getfavor_v2") > -1){
							c.method("Invoke").invoke(Il2Cpp.String.from(JSON.stringify({"levelid":0,"code":0,"character":{}})));
						}else if(a.toString().indexOf("user/startlevel_v2") > -1){
							let data = parseReq(b);
							c.method("Invoke").invoke(Il2Cpp.String.from(JSON.stringify({"character":[],"chatids":[{"steps":[],"time":1743053191}],"line":{},"last_play_level":data.levelid,"code":0,"islinecover":true,"level_unlock_time":1743053191})));
						}else if(a.toString().indexOf("user/passlevel_v2") > -1){
							let data = parseReq(b);
							c.method("Invoke").invoke(Il2Cpp.String.from(JSON.stringify({"character":{},"line":[data.levelid],"next_player_level":data.next_levelid,"code":0,"level":[{"passtime":1743053038,"id":10010001,"status":1,"unlocktime":1742939896}],"islinecover":0})));
						}else if(a.toString().indexOf("user/unlockchapter") > -1){
							c.method("Invoke").invoke(Il2Cpp.String.from(JSON.stringify({"drewlist":{},"code":0})));
						}else if(a.toString().indexOf("https") > -1){
							c.method("Invoke").invoke(Il2Cpp.String.from(JSON.stringify({})));
						}
					}
				} catch (error) {
					showMessageBoxA(error.toString())
		...
		Object.defineProperty(exports, "__esModule", {
			value: !0
		}), exports.start = void 0, require("frida-il2cpp-bridge"), exports.start = e;

	}, { "frida-il2cpp-bridge": 31 }], 3: [function (require, module, exports) {
		"use strict";
